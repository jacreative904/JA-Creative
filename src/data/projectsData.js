export const projectsData = [
  {
    ...
    results: "Achieved a 45% increase in conversion rate (from 2.3% to 3.3%), reduced cart abandonment by 30%, and improved mobile engagement by 60%. Customer satisfaction scores increased from 3.2 to 4.6 out of 5.",
    technologies: ["React", "Node.js", "MongoDB", "Stripe", "Figma", "Adobe Creative Suite"]
  },
  {
    id: 2,
    ...
    solutions: "Developed a minimalist logo using organic shapes, selected an earthy yet sophisticated color palette, chose typography that balanced readability with personality, and created comprehensive brand guidelines for consistent application.",
    results: "The brand identity helped secure $500K in seed funding, increased social media engagement by 200%, and contributed to a successful product launch with 1,000+ pre-orders in the first month.",
  ...
  },
  {
    ...
    solutions: "Developed a modular animation system with consistent timing and easing, created responsive motion graphics that scaled across devices, and implemented interactive elements that responded to audience engagement.",
    results: "The motion graphics contributed to a 25% increase in conference attendance, generated 2M+ social media impressions, and won the 'Best Visual Design' award at the Event Marketing Awards.",
    technologies: ["After Effects", "Cinema 4D", "Adobe Premiere", "Figma", "Lottie"]
  },
  {
    id: 4,
    ...
    solutions: "Implemented biometric authentication, created clear visual hierarchy for financial data, designed accessible color schemes and typography, and developed progressive disclosure patterns for complex features.",
    results: "App achieved 4.8/5 star rating in app stores, reduced customer service calls by 40%, and increased mobile banking adoption by 65% among existing customers.",
    technologies: ["React Native", "TypeScript", "Node.js", "PostgreSQL", "Figma", "Jest"]
  },
  {
    id: 5,
    ...
    solutions: "Developed a flexible design system that could adapt to different aspect ratios and platforms, created animated elements that would capture attention without being intrusive, and optimized all assets for fast loading times.",
    results: "Campaign achieved 3.2% click-through rate (industry average 0.9%), generated 500K+ impressions, and contributed to a 30% increase in product pre-orders during the campaign period.",
    technologies: ["Adobe Animate", "Adobe Photoshop", "Adobe After Effects", "Google Web Designer"]
  },
  {
    id: 6,
    ...
    solutions: "Developed a flexible grid system that could accommodate various content types, selected typography that complemented architectural imagery, and created visual elements that guided readers through complex information.",
    results: "The issue won the Society of Publication Designers Award for Excellence, increased newsstand sales by 40%, and generated requests for design services from 5 other publications.",
